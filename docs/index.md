...
[Say hi](mailto:sarraamri2508@gmail.com){ .md-button }
</div>

</div>

<div class="sa-blob-wrap">
  <div class="sa-blob"></div>
  <!-- TODO (Sarra): drop your headshot in docs/assets/ and swap the emoji for
       <img src="assets/sarra.jpg" alt="Sarra Amri"> -->
  <div class="sa-portrait">👩🏻‍💻</div>
</div>
...
-   :material-bug:{ .lg .middle } **[Defects I find while documenting](qa/defects.md)**
    ...
    ---
    My Jira reporting format, field by field: reproduction steps a developer
    can follow on the first try.

    <span class="badge b-qa">Bug reporting</span><span class="badge b-work">Work</span>

-   :material-api:{ .lg .middle } **[Postman collection as runnable docs](qa/postman-ci.md)**

    ---
    Auth, CRUD, and error cases with assertions; Newman runs the suite in CI on every push.
...
<div class="sa-row">
<span class="sa-icon">🌍</span>
<span>Arabic (native), French (C1), English (C1). Open to relocation and visa sponsorship.</span>
</div>

<div class="sa-row">
<span class="sa-icon">📫</span>
<span class="sa-pills">
<a class="sa-pill" href="mailto:sarraamri2508@gmail.com">Email</a>
<a class="sa-pill" href="https://linkedin.com/in/sarra-amri-019902217">LinkedIn</a>
<a class="sa-pill" href="https://github.com/Sarraamri">GitHub</a>
<a class="sa-pill" href="assets/Sarra_Amri.pdf">Resume (PDF)</a>
</span>
</div>
