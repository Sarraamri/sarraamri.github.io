...
2+ years documenting the Reis™ compliance suite (AML · KYC · TBML), including a full documentation
set built from scratch for a product launch. I verify every feature I write about, file Jira tickets
for what breaks, and build Postman collections that double as runnable API docs.
...
-   :material-bug:{ .lg .middle } **[Defects I find while documenting](qa/defects.md)**
    ...
    ---
    My Jira reporting format with sanitized real examples — reproduction steps a developer
...
:books: 700+ page Confluence knowledge base · 50+ banking clients · 3 release cycles · 1 product launch
...
[GitHub](https://github.com/Sarraamri) ·
[Resume (PDF)](#) <!-- TODO: link your CV PDF (drop it in docs/assets/ and link assets/Sarra_Amri.pdf) -->
